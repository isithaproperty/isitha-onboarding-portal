export type TrainingModule = { slug:string; title:string; category:string; duration:string; sections:{title:string; body:string}[] };
export const trainingModules: TrainingModule[] = [
 {slug:'hr-employment', title:'HR & Employment Training', category:'Employment', duration:'35 min', sections:[
 ...
 {slug:'ohsa-awareness', title:'OHSA Awareness Training', category:'Health & Safety', duration:'30–45 min', sections:[
 ...
 {slug:'emergency-induction', title:'Emergency & Office Induction', category:'Health & Safety', duration:'15 min', sections:[
